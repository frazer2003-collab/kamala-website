-- Twin/double for every room (undo Superior-only / nullable bed_setup).
-- Run if you already applied an older migrate-bed-setup.sql or migrate-bed-setup-optional.sql.
