...
const messages = {
  en: {
    ...
    room: "Room",
    beds: "Bed setup",
    bedsHelp: "One double bed, or two single beds.",
    bedDouble: "One double bed",
    bedTwin: "Two single beds",
  ...
  th: {
    ...
    room: "ห้องพัก",
    beds: "รูปแบบเตียง",
    bedsHelp: "เตียงคู่หนึ่งหลัง หรือเตียงเดี่ยวสองหลัง",
    bedDouble: "เตียงคู่หนึ่งหลัง",
    bedTwin: "เตียงเดี่ยวสองหลัง",
